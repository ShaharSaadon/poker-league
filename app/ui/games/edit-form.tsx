...
import { PlayerField, GameForm } from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
import { State, updateGame } from '@/app/lib/actions';
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={game.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  defaultChecked={game.status === 'paid'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                  aria-describedby="status-error"
                />
                <label
